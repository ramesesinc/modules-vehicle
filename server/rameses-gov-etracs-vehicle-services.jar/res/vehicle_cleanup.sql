...
update vehicle_unit set supersederid = NULL;
update vehicle_account SET supersederid = NULL;
update vehicle_franchise SET appid = NULL,unitid=NULL,acctid=null;
update vehicle_application SET unitid=NULL,acctid=null,permitid=null;
